...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'drivebali2016@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'QRTaxi Club'; // Isikan dengan nama pengirim
    protected $password = 'qASEwS12Df8Vuj9Y'; // Isikan dengan password email pengirim
